...
def load_image(file_path):
    """Loads and transforms an Cifar-FS image.
...
class CifarDataset(dataset.Dataset):
    """Cifar-FS dataset for meta-learning.
    ...
    _BASE_PATH = './cifar-100'
    _GDD_FILE_ID = '1pTsCCMDj45kzFYgrnO67BWVbKs48Q3NI'
    ...
    def __init__(self, num_support, num_query):
        ...
        # if necessary, download the CIFAR-FS dataset 
        # - add unzip code?
        ...
        self._image_folders = glob.glob(
            os.path.join(self._BASE_PATH, 'data/*/'))
...
class CifarSampler(sampler.Sampler):
    """Samples task specification keys for an Cifar-FS Dataset."""
...
def get_cifar_dataloader(
    ...
    """Returns a dataloader.DataLoader for Cifar-FS.
    ...
    return dataloader.DataLoader(
        dataset=CifarDataset(num_support, num_query),
        batch_size=batch_size,
        sampler=CifarSampler(split_idxs, num_way, num_tasks_per_epoch),
        num_workers=8,
        collate_fn=identity,
