...
# python maml_higher.py --outer_lr 1e-3 --num_augs 3 --num_inner_steps 1 --aug_net_size 3 --l2_wd 1e-4 --aug_noise_prob 0.1 --dataset imagenet --pretrain True

# python maml_higher.py --outer_lr 1e-3 --num_augs 3 --num_inner_steps 1 --aug_net_size 3 --l2_wd 1e-4 --aug_noise_prob 0.1 --dataset imagenet --pretrain False
